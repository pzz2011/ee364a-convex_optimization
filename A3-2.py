...
prob_a.solve()
print "(a)"
print "Status: ", prob_a.status
print "Optimal value: ", prob_a.value
print "Optimal var(x, y): ", x.value, y.value

prob_b = Problem(obj_b, constraints)
prob_b.solve()
print "(b)"
print "Status: ", prob_b.status
